    ...
    <div className="dark min-h-screen bg-background text-foreground">
      ...
      <section className="container mx-auto px-4 py-20 text-center">
        <div className="max-w-4xl mx-auto">
          <h1 className="text-5xl md:text-7xl font-bold mb-6 leading-tight">
            ...
            <span className="text-violet-600"> understands</span> you
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button size="lg" className="cursor-pointer text-lg px-8 py-6 bg-violet-600 hover:bg-violet-700 text-white">
              Start chatting now
              <ArrowRight className="ml-2 h-5 w-5" />
            </Button>
            <Button size="lg" className="cursor-pointer text-lg px-8 py-6 bg-transparent border border-violet-600 hover:bg-violet-700 text-white">
              Watch demo
            </Button>
          </div>
        </div>
      ...
      <section id="features" className="container mx-auto px-4 py-20">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold mb-4">Powerful features for every need</h2>
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            From creative writing to complex problem-solving, our AI adapts to your unique requirements
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <Card className="bg-card border-border">
            <CardContent className="p-8 text-center">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Get instant responses with our optimized AI models. No waiting, just immediate intelligent assistance.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="bg-card border-border">
            <CardContent className="p-8 text-center">
              ...
              <p className="text-muted-foreground leading-relaxed">
                Share conversations and collaborate with your team. Perfect for businesses and creative projects.
              </p>
            </CardContent>
          </Card>
        </div>
        ...
        <Card className="bg-card border-border">
          <CardContent className="p-12 text-center">
            ...
            <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
              Join millions of users who trust our AI for their daily tasks. Start your journey today and experience the
              difference.
            </p>
            <Button size="lg" className="text-lg px-12 py-6 bg-violet-600 hover:bg-violet-700 text-white cursor-pointer">
